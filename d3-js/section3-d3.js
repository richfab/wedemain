    ...
    d3.csv("data/section3.csv", function(d) {
        ...
        $(window).bind("scroll", function(event) {
            ...
            if(!chartHasBeenShowed){
                ...
                $("#section3-bar-chart-limit:in-viewport").each(function() {
        ...
        function init(){
            ...
            var svg = d3.select("#section3-bar-chart")
                    .append("svg")
                    .attr("width", w)
                    .attr("height", h);
            ...
            var websiteLisbis = d3.select("#section3bis-webisteUl").selectAll("li")
                    .data(dataset)
                    .enter()
                    .append("li");
        ...
        var svg = d3.select("#section3-sunburst-chart").append("svg")
        ...
        $(window).bind("scroll", function(event) {
            ...
            if(!arcChartHasBeenShowed){
                ...
                $("#section3-sunburst-chart-limit:in-viewport").each(function() {
        ...
        var changeWebsite = function() {
            ...
            $(".section3-websiteLi span").removeClass("selected");
            
            //on selectionne le site correspondant
            var websiteLiName = $(".section3-websiteLi[index='"+$(this).attr("index")+"'] span");
            websiteLiName.addClass("selected");
            
            //on change les données
            var websiteLi = $(".section3-websiteLi[index='"+$(this).attr("index")+"']");
            
            $("#section3-dataQuantiteDonnees").text(dataNumberToNice(websiteLi.attr("data-quantite")));
            $("#section3-dataConsommation").text(dataNumberToNice(websiteLi.attr("data-consommation")));
            $("#section3-bar-chart-usb-number").text(dataNumberToNice(websiteLi.attr("data-quantite")/1000));
            $('#section3-bar-chart-ampoule-number').text(dataNumberToNice(websiteLi.attr("data-consommation")/60));
        };
        ...
        function displayFirstWebsite(){
            ...
            //on selectionne le site correspondant
            var websiteLiName = $(".section3-websiteLi[index='0'] span");
            websiteLiName.addClass("selected");
            
            //on change les données
             var websiteLi = $(".section3-websiteLi[index='0']");
